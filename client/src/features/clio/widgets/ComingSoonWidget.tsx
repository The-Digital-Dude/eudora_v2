  ...
  return (
    <div className="border-border bg-card flex flex-col items-center justify-center rounded-2xl border-2 p-8 text-center transition-all duration-300">
      <div className="relative mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-primary/10 text-primary">
        ...
        <span className="absolute -top-1 -right-1 flex h-3.5 w-3.5 animate-ping rounded-full bg-primary" />
        <span className="absolute -top-1 -right-1 flex h-3.5 w-3.5 rounded-full bg-primary" />
      </div>
