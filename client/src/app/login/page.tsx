          ...
          <div className="mb-6 grid grid-cols-2 gap-3">
            {googleOAuthConfigured ? (
              ...
              <button
                ...
                className="border-border bg-card text-card-foreground flex items-center justify-center gap-2 rounded-xl border px-4 py-2.5 text-xs font-semibold shadow-sm opacity-50"
              >
                <GoogleIcon />
                Google
              </button>
