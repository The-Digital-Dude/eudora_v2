  ...
  return (
    <div className="animate-fade-in space-y-6 text-neutral-900 dark:text-zinc-50">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <div className="flex flex-col gap-4 border-b border-neutral-200 pb-4 md:flex-row md:items-center md:justify-between dark:border-zinc-800">
          <TabsList className="h-11 w-fit rounded-xl bg-neutral-100 p-1 dark:bg-zinc-950">
            <TabsTrigger
              value="campuses"
              className="rounded-lg px-4 py-2 text-xs font-semibold data-[state=active]:bg-white data-[state=active]:shadow-sm data-[state=active]:dark:bg-zinc-800"
            >
          ...
          <div className="relative w-full md:w-72">
            ...
            <Input
              ...
              className="h-10 rounded-xl border-neutral-200 bg-white pl-9 text-xs text-neutral-900 dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-50"
            />
          </div>
        </div>
          ...
          {campusesLoading ? (
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              {[...Array(3)].map((_, idx) => (
                <div
                  key={idx}
                  className="h-44 animate-pulse rounded-3xl border border-neutral-200 bg-neutral-100 dark:border-zinc-800 dark:bg-zinc-900"
                />
              ))}
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              {filteredCampuses.map((campus) => (
                <div
                  key={campus.id}
                  className="group flex flex-col justify-between rounded-3xl border border-neutral-200/80 bg-white p-5 shadow-[0_4px_12px_rgba(0,0,0,0.015)] transition-all hover:shadow-md dark:border-zinc-800 dark:bg-zinc-900"
                >
                  <div className="space-y-3">
                    <div className="flex items-start justify-between">
                      <div className="space-y-1">
                        ...
                        <h3 className="font-display text-sm font-bold text-neutral-900 dark:text-zinc-50">
                          {campus.name}
                        </h3>
                      </div>
                      <span
                    ...
                    {campus.description && (
                      <p className="line-clamp-2 text-[11px] leading-relaxed text-neutral-400 dark:text-zinc-400">
                        {campus.description}
                      </p>
                    )}

                    <div className="dark:border-zinc-850 space-y-1.5 border-t border-neutral-50 pt-2">
                      {campus.email && (
                  ...
                  <div className="dark:border-zinc-850 mt-5 flex items-center justify-end gap-2 border-t border-neutral-50 pt-3">
                    <Button
                      onClick={() => handleOpenCampusDialog(campus)}
                      variant="outline"
                      className="h-8 rounded-lg border-neutral-200 p-2 text-neutral-500 hover:bg-neutral-50 hover:text-neutral-900 dark:border-zinc-800 dark:hover:bg-zinc-800 dark:hover:text-zinc-200"
                    >
                    ...
                    <Button
                      ...
                      variant="outline"
                      className="h-8 rounded-lg border-rose-100 p-2 text-rose-500 hover:bg-rose-50 hover:text-rose-700 dark:border-rose-900/30 dark:hover:bg-rose-950/20"
                    >
            ...
            <div className="space-y-2 rounded-3xl border border-dashed border-neutral-200 bg-white py-12 text-center dark:border-zinc-800 dark:bg-zinc-900">
              <School className="mx-auto h-8 w-8 text-neutral-300 dark:text-zinc-700" />
          ...
          {programsLoading ? (
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              {[...Array(3)].map((_, idx) => (
                <div
                  key={idx}
                  className="h-40 animate-pulse rounded-3xl border border-neutral-200 bg-neutral-100 dark:border-zinc-800 dark:bg-zinc-900"
                />
              ))}
            </div>
                      ...
                      <span
                        className={`inline-flex items-center rounded-full px-2 py-0.5 text-[10px] font-bold ${
                          program.status === "ACTIVE"
                            ? "border border-emerald-100 bg-emerald-50 text-emerald-700 dark:border-emerald-900/30 dark:bg-emerald-950/20 dark:text-emerald-400"
                            : "dark:border-zinc-750 border border-neutral-200 bg-neutral-100 text-neutral-400 dark:bg-zinc-800 dark:text-zinc-500"
                        }`}
                      >
                        {program.status}
                      </span>
            ...
            <div className="space-y-2 rounded-3xl border border-dashed border-neutral-200 bg-white py-12 text-center dark:border-zinc-800 dark:bg-zinc-900">
              <GraduationCap className="mx-auto h-8 w-8 text-neutral-300 dark:text-zinc-700" />
              <p className="text-xs font-semibold text-neutral-500 dark:text-zinc-400">
                No programs found
              </p>
              <p className="text-[10px] text-neutral-400 dark:text-zinc-500">
          ...
          <form onSubmit={handleSaveCampus} className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              <textarea
                ...
                className="dark:placeholder:text-zinc-650 min-h-[70px] w-full rounded-xl border border-neutral-200 bg-white p-3 text-xs text-neutral-900 placeholder:text-neutral-300 focus:border-neutral-900 focus:ring-1 focus:ring-neutral-900/10 focus:outline-none dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-50 dark:focus:border-zinc-300"
              />
            </div>
          ...
          <form onSubmit={handleSaveProgram} className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              <textarea
                ...
                className="dark:placeholder:text-zinc-655 min-h-[70px] w-full rounded-xl border border-neutral-200 bg-white p-3 text-xs text-neutral-900 placeholder:text-neutral-300 focus:border-neutral-900 focus:ring-1 focus:ring-neutral-900/10 focus:outline-none dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-50 dark:focus:border-zinc-300"
              />
            </div>
